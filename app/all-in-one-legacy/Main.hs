...
getName (XmlPage _ (ModuleName _ n) _ _ _ _ _) = n
getName (XmlHybrid _ Nothing _ _ _ _ _ _ _) = "Main"
getName (XmlHybrid _ (Just (ModuleHead _ (ModuleName _ n) _ _)) _ _ _ _ _ _ _) = n
...
removeImports ours (Module l mh prags imports decls) =
  ...
  where
    go i = getName' (importModule i) `notElem` ours
